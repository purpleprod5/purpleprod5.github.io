...
function animateOnScroll() {
    const elements = document.querySelectorAll('.skill-card, .about-content, .resume-container');
...
document.querySelectorAll('.skill-card, .about-content, .resume-container').forEach(element => {
